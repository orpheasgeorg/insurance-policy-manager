...
A mini REST API project simulating basic functionality for an insurance company.
It has 3 core entities: Customer, Policy, and Claim. A Customer can have multiple Policies, and each Policy can have multiple Claims. The project follows a standard Controller → Service → Repository architecture.
